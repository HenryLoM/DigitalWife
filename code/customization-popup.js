...
document.getElementById("customize-btn").addEventListener("click", () => {
    ...
    const bodiesList = [
        { label: "White",  path: "./media/nicole/bodies/white.png"  },
        { label: "Tan",    path: "./media/nicole/bodies/tan.png"    },
        { label: "Black",  path: "./media/nicole/bodies/black.png"  },
        { label: "Albino", path: "./media/nicole/bodies/albino.png" },
    ];

    const hairList = [
        { label: "Lob:\n",    separator: true },
        { label: "Black",     path: "./media/nicole/hair/lob-black.png"   },
        { label: "Brown",     path: "./media/nicole/hair/lob-brown.png"   },
        { label: "Blonde",    path: "./media/nicole/hair/lob-blonde.png"  },
        { label: "Silver",    path: "./media/nicole/hair/lob-silver.png"  },
        { label: "Pink",      path: "./media/nicole/hair/lob-pink.png"    },
        { label: "\nLong:\n", separator: true },
        { label: "Black",     path: "./media/nicole/hair/long-black.png"  },
        { label: "Brown",     path: "./media/nicole/hair/long-brown.png"  },
        { label: "Blonde",    path: "./media/nicole/hair/long-blonde.png" },
        { label: "Silver",    path: "./media/nicole/hair/long-silver.png" },
        { label: "Pink",      path: "./media/nicole/hair/long-pink.png"   },
        { label: "\nBob:\n",  separator: true },
        { label: "Black",     path: "./media/nicole/hair/bob-black.png"  },
        { label: "Brown",     path: "./media/nicole/hair/bob-brown.png"  },
        { label: "Blonde",    path: "./media/nicole/hair/bob-blonde.png" },
        { label: "Silver",    path: "./media/nicole/hair/bob-silver.png" },
        { label: "Pink",      path: "./media/nicole/hair/bob-pink.png"   },
        { label: "\nHime:\n", separator: true },
        { label: "Black",     path: "./media/nicole/hair/hime-black.png"  },
        { label: "Brown",     path: "./media/nicole/hair/hime-brown.png"  },
        { label: "Blonde",    path: "./media/nicole/hair/hime-blonde.png" },
        { label: "Silver",    path: "./media/nicole/hair/hime-silver.png" },
        { label: "Pink",      path: "./media/nicole/hair/hime-pink.png"   },
        { label: "\nTwin:\n", separator: true },
        { label: "Black",     path: "./media/nicole/hair/twin-black.png"  },
        { label: "Brown",     path: "./media/nicole/hair/twin-brown.png"  },
        { label: "Blonde",    path: "./media/nicole/hair/twin-blonde.png" },
        { label: "Silver",    path: "./media/nicole/hair/twin-silver.png" },
        { label: "Pink",      path: "./media/nicole/hair/twin-pink.png"   },
    ];

    const clothesList = [
        { label: "Home & Out:\n",           separator: true },
        { label: "Green hoodie",            path: "./media/nicole/clothes/hoodie-green.png"         },
        { label: "Loose hoodie",            path: "./media/nicole/clothes/hoodie-loose.png"         },
        { label: "Black boatneck",          path: "./media/nicole/clothes/boatneck-black.png"       },
        { label: "Pink boatneck",           path: "./media/nicole/clothes/boatneck-pink.png"        },
        { label: " | ",                     separator: true },
        { label: "Casual bloose",           path: "./media/nicole/clothes/bloose-casual.png"        },
        { label: "Offical bloose",          path: "./media/nicole/clothes/bloose-offical.png"       },
        { label: "Casual vest",             path: "./media/nicole/clothes/casual-vest.png"          },
        { label: "Summer dress",            path: "./media/nicole/clothes/summer-dress.png"         },
        { label: "Coat and scarf",          path: "./media/nicole/clothes/coat-and-scarf.png"       },
        { label: "\nUniforms & Special:\n", separator: true },
        { label: "Academy uniform",         path: "./media/nicole/clothes/uniform-academy.png"      },
        { label: "PE uniform",              path: "./media/nicole/clothes/uniform-pe.png"           },
        { label: "Light seifuku",           path: "./media/nicole/clothes/uniform-school-light.png" },
        { label: "Dark seifuku",            path: "./media/nicole/clothes/uniform-school-dark.png"  },
        { label: " | ",                     separator: true },
        { label: "Tank top",                path: "./media/nicole/clothes/tank-top.png"             },
        { label: "Swimsuit",                path: "./media/nicole/clothes/swimsuit.png"             },
        { label: "Bikini",                  path: "./media/nicole/clothes/bikini.png"               },
        { label: "\nIntimate:\n",           separator: true },
        { label: "Pajama",                  path: "./media/nicole/clothes/pajama.png"               },
        { label: "Towel",                   path: "./media/nicole/clothes/towel.png"                },
        { label: "Bra",                     path: "./media/nicole/clothes/bra.png"                  },
        { label: "Nothing",                 path: "./media/nicole/additional/-censore.png"          }  // change -censore to -nipples for uncensored output
    ];

    const placesList = [
        { label: "Home:\n",               separator: true },
        { label: "Living room",           path: "./media/places/living-room.png" },
        { label: "Bedroom",               path: "./media/places/bedroom.png"     },
        { label: "Kitchen",               path: "./media/places/kitchen.png"     },
        { label: "Bathroom",              path: "./media/places/bathroom.png"    },
        { label: "\nCity & Lifestyle:\n", separator: true },
        { label: "Street",                path: "./media/places/street.png"      },
        { label: "Bus stop",              path: "./media/places/bus-stop.png"    },
        { label: "Train",                 path: "./media/places/train.png"       },
        { label: " | ",                   separator: true },
        { label: "Park",                  path: "./media/places/park.png"        },
        { label: "Cafe",                  path: "./media/places/cafe.png"        },
        { label: "Restaurant",            path: "./media/places/restaurant.png"  },
        { label: "Cinema",                path: "./media/places/cinema.png"      },
        { label: "\nMisc:\n",             separator: true },
        { label: "Classroom",             path: "./media/places/classroom.png"   },
        { label: "Beach",                 path: "./media/places/beach.png"       },
        { label: "No Background",         path: null                             }
    ];

    const additionalList = [
        { label: "Flowers:\n",           separator: true },
        { label: "Pink flower",          path: "./media/nicole/additional/flower.png"        },
        { label: "Red rose",             path: "./media/nicole/additional/rose-red.png"      },
        { label: "White rose",           path: "./media/nicole/additional/rose-white.png"    },
        { label: "\nRibbons & Bands:\n", separator: true },
        { label: "White ribbon",         path: "./media/nicole/additional/ribbon-white.png"  },
        { label: "Black ribbon",         path: "./media/nicole/additional/ribbon-black.png"  },
        { label: "Yellow ribbon",        path: "./media/nicole/additional/ribbon-yellow.png" },
        { label: " | ",                  separator: true },
        { label: "White band",           path: "./media/nicole/additional/band-white.png"    },
        { label: "Black band",           path: "./media/nicole/additional/band-black.png"    },
        { label: "Yellow band",          path: "./media/nicole/additional/band-yellow.png"   },
        { label: "\nMisc:\n",            separator: true },
        { label: "Headphones",           path: "./media/nicole/additional/headphones.png"    },
        { label: "Chocker",              path: "./media/nicole/additional/choker.png"        },
        { label: "Blush",                path: "./media/nicole/additional/makeup.png"        },
